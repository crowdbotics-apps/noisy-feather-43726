"""
Django settings for noisy_feather_43726 project.
...
ROOT_URLCONF = 'noisy_feather_43726.urls'
...
WSGI_APPLICATION = 'noisy_feather_43726.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_feather_43726 API",
    "DESCRIPTION": "API documentation for noisy_feather_43726 App",
    "VERSION": "v1",
}
